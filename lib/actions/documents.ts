...
//
// MULTI_CURRENT_DOC_TYPES (General, Marketing) go further still: those
// uploads are independent documents that happen to share a doc_type, not
// revisions of one lineage, so they get no shared version counter either.
// See the isMultiCurrent branch below.
//
