...
function RemoveButton({ name, onConfirm }: { name: string; onConfirm: () => Promise<string | null> }) {
  ...
  return (
    <>
      ...
      <ConfirmDialog
        ...
        title={`Remove ${name}?`}
        description="Travel and hotel assignments must be removed first. This cannot be undone."
        confirmLabel="Remove"
